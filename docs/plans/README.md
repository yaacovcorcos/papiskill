...
This directory tracks active and historical implementation plans.

## Active Plans

| Plan | Status | Owner | Purpose |
|---|---|---|---|
...
- Mark completed slices with evidence, not hope.
- If a plan is superseded, link to the replacement instead of deleting history.
- A feature is not complete until code, tests, docs, and runbooks agree.
